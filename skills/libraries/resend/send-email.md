---
name: skills/libraries/resend/send-email
...
sources:
  - https://github.com/resend/resend-skills/tree/main/send-email
---
...
- Install the Node.js SDK or use cURL: [references/installation.md](references/installation.md)
- Store your API key in `RESEND_API_KEY`

## Quick Start

1. **Install SDK** (preferred) or use cURL - See [references/installation.md](references/installation.md)
2. **Choose single or batch** based on the decision matrix above
3. **Implement best practices** - Idempotency keys, error handling, retries
...
*In the Resend Node.js SDK, use `replyTo`.
