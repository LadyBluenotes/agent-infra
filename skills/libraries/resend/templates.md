---
name: skills/libraries/resend/templates
...
sources:
  - https://github.com/resend/resend-skills/tree/main/templates
---
...
For variable constraints, reserved names, full CRUD examples, pagination, and version history, see [references/templates-reference.md](references/templates-reference.md).
